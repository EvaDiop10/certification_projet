        ...
        <div className="  p-1">
            <form className="form-control bg-white border-0 rounded-3 shadow-sm" onSubmit={handleSubmit} ref={FormRef}>
                ...
                <div className="row">
                    ...
                    <textarea className="input-group  border border-success rounded-3 mb-3 p-1"  placeholder="Description" name="description"onChange={inputChange} />
                <button className=" btn btn-success fw-light border-success text-white  border border-success rounded-3 mb-3" >Ajouter Rendez-vous</button>
            </form>
        </div>
    )
}
